      ...
      >
        <div className="rounded-2xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 shadow-soft dark:shadow-soft-dark p-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
            Start with a secure password — you can promote admins via the seed script.
          </p>
          {apiError && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 px-4 py-2.5 text-slate-900 dark:text-white focus:ring-2 focus:ring-brand-500 outline-none"
              />
            ...
            <motion.button
              ...
              type="submit"
              disabled={submitting}
              className="w-full py-3 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-semibold disabled:opacity-60"
            >
